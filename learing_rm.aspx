<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="learing_rm.aspx.cs" Inherits="stock_market_learning.learing_rm" %>
...
<body>
  ...
  <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
     <%-- <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo">--%>
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-black ">risk and risk management</span>
  </a>
